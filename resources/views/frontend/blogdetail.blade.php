                            ...
                            <div class="single-blog-wrap mb-40">
                                <div class="latest-blog-content mt-0">
                                    ...
                                    <ul class="post-meta">
                                        ...
                                        <li class="post-date"> {{date('d/m/Y',strtotime($data->update_at))}}</li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-latest-blog mt-30">
                                    <div class="latest-blog-image">
                                        <a href="{{route('shop.blogdetails',['slug'=>$item->slug])}}"><img src="{{asset($item->image)}}" alt=""></a>
                                    </div>
                                    <div class="latest-blog-content mt-20">
                                        <h4><a href="{{route('shop.blogdetails',['slug'=>$item->slug])}}">{{$item->title}}</a></h4>
                                        <ul class="post-meta">
                                            <li class="post-date">{{date('d/m/Y',strtotime($item->update_at))}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <form action="#" class="comment-form-area">
                                            ...
                                            <div class="row comment-input">
                                                <div class="col-md-4 comment-form-author mt-15">
                                                    <label>Name <span class="required">*</span></label>
                                                    <input type="text" required="required" name="Name">
                                                </div>
                                                <div class="col-md-4 comment-form-email mt-15">
