...
{{--                                        <form action="{{route('shop.update_cart_quantity')}}" method="POST">--}}
                                            ...
                                            <input class="quantity" name="cart_quantity" value="{{$item->qty}}" type="number">
                                            <br>
                                            <div class="input-color">
                                    ...
                                    <td class="plantmore-product-remove"><a href="{{URL::to('/gio-hang/xoa-sp-gio-hang/'.$item->rowId)}}"><i class="fa fa-times"></i></a></td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="coupon-all">
                            ...
                            <div class="coupon2 mt-5">
                                <a href="{{ route('shop.cart.destroy') }}" class="btn">Hủy đơn hàng</a>
                                <a href="{{route('shop.index')}}" class="btn ">Tiếp tục </a>
                    ...
                    <div class="col-md-4 ml-auto">
                        <div class="cart-page-total">
                            ...
                            if($customer_id!=NULL){
                            ?>
                            <a href="{{route('shop.cart.order')}}" class="proceed-checkout-btn">Tiến Hành Đặt Hàng</a>
                            <?php
                            }else{
                            ?>
                            <a href="{{route('shop.login')}}" class="proceed-checkout-btn">Tiến Hành Đặt Hàng</a>
                            <?php
                            }
                            ?>
            ...
            @if(Session::get('cart'))
                <form action="{{route('shop.check_coupon')}}" method="post" >
                    ...
                    <div class="coupon css-coupon">
                        ...
                        <button class=" check_coupon continue-btn" name="apply_coupon"  type="submit">Áp dụng</button>
                    </div>
                </form>
            @endif
        </div>
