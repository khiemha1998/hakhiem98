...
@section('content')
    <section class="content-header">
        <h1>
            Thêm mới Article <a href="{{route('admin.blog.index')}}" class="btn btn-success pull-right"><i class="fa fa-list"></i> Danh Sách</a>
        </h1>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.blog.update', ['id' => $data->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
