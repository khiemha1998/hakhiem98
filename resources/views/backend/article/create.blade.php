...
@section('content')
    <section class="content-header">
        <h1>
            Thêm mới Article <a href="{{route('admin.article.index')}}" class="btn btn-success pull-right"><i class="fa fa-list"></i> Danh Sách</a>
        </h1>
    </section>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type">
                                            ...
                                            <option value="3">article right</option>
                                            <option value="4">article left</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
